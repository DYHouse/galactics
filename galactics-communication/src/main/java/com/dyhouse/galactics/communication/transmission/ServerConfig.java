...
public class ServerConfig implements Cloneable {
    private int listenPort =Integer.parseInt(System.getProperty("galactics.collector.server.port", "9999"));
    private int serverWorkerThreads = 8;
    private int serverCallbackExecutorThreads = 0;
    private int serverSelectorThreads = 3;
    private int serverOnewaySemaphoreValue = 256;//控制单向的信号量
    private int serverChannelMaxIdleTimeSeconds = 120;//服务空闲心跳检测时间间隔
